...
async function signinLinkedinController(req, res) {
  try {
    ...
    if (clientsData !== null && professionalData === null) {
      //Check if it's clients account
      if (clientsData.clientRegisterationType === "linkedin") {
      ...
      //Check if it's Professional account

      if (professionalData.professionalRegisterationType === "linkedin") {
